...
3. **若数学公式显示出现问题大家也可通过jupyter notebook链接查看：[Graph-neural-network](https://nbviewer.jupyter.org/github/Knowledge-Precipitation-Tribe/Graph-neural-network/blob/master/jupyter%20notebook/Graph-neural-network.ipynb)**
